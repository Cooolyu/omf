...
@ServerEndpoint(value = "/websocket/airCold")
public class AircoldServerEndpoint {

private static final Logger sysLogger = Logger.getLogger(StateDefine.SYS_LOG);
	
    private static final Set<AircoldServerEndpoint> connections = new CopyOnWriteArraySet<>();
...
//	}
	...
	public static void broadcast(String msg) {
		...
		for (AircoldServerEndpoint client : connections) {
            try {
